  ...
  return (
    <section id="about" ref={sectionRef} className="py-20 bg-gradient-to-br from-black via-gray-900 to-black relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center mb-20">
          ...
          <div className={`space-y-8 transition-all duration-1000 delay-500 ${isVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-10'
            ...
            <div className="text-lg md:text-xl text-gray-300 leading-relaxed space-y-6">
              ...
              <p>
                My journey started with curiosity and somewhere along the way it became a full-on obsession with building
                <span className="font-bold text-magenta-400"> exceptional digital experiences</span>.
                I don’t just fix problems — I rethink what’s possible.
              </p>
              <p className="text-center">
                <span className="inline-flex items-center gap-1">
                  <Heart className="text-magenta-400" size={20} fill="currentColor" />
                  <span className="font-semibold">
                    This is what I do. And I <span className="font-bold text-magenta-400">love</span> doing it.
                  </span>
                  <Heart className="text-magenta-400" size={20} fill="currentColor" />
                </span>
              </p>
            ...
            <div className="bg-gradient-to-r from-pink-500/10 to-magenta-500/10 p-8 rounded-2xl border border-pink-500/30 backdrop-blur-sm">
              ...
              <p className="text-gray-300 text-lg leading-relaxed">
                "This is not just work — it’s a reflection of how I understand the world and my place within it"
              </p>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {highlights.map((item, index) => (
              <div
                key={index}
                className={`group relative bg-gradient-to-br ${item.color} backdrop-blur-sm p-6 rounded-2xl border border-pink-500/30 hover:border-pink-400/50 transform hover:scale-105 transition-all duration-500 cursor-pointer ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
                  }`}
                style={{
              ...
              >
                <div className="relative z-10">
                  ...
                  {/* Tech Stack */}
                  <div className={`flex flex-wrap gap-2 transition-all duration-300 ${activeCard === index ? 'opacity-100 max-h-20' : 'opacity-70 max-h-0 overflow-hidden'
                    }`}>
        ...
        {/* Stats Section */}
        {/* <div className={`grid grid-cols-2 md:grid-cols-4 gap-8 transition-all duration-1000 delay-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'
          }`}>
